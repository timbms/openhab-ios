...
class OpenHABAppDelegate: UIResponder, UIApplicationDelegate{ // , OpenHABAppDataDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool {
        ...
        //MARK _ Correct this
        //AVAudioSession.sharedInstance().setCategory(AVAudioSession.Category.ambient, mode: AVAudioSession.CategoryOptions.duckOthers, options: nil)
